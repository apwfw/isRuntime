...
public class TagTools {
   ...
   *
   * @param object    The object to be tagged
   * @param tagString A tag string of the form "key1=value1;key2=value2..."
   */
   ...
   * @param key    The key value that is searched
   ...
   *
   * @param object The tagged object
   * @param key    The key value for the tags to be removed
   */
   ...
   *
   * @param object The tagged object.
   * @param key    The key for the tag to be replaced
